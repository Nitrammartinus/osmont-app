            ...
            <div className="max-w-2xl mx-auto">
                 <div className="bg-white rounded-2xl shadow-xl p-6">
                     ...
                     <div className="space-y-4">
                         ...
                         <input type="number" placeholder="Budget" value={editingProject.budget || ''} onChange={e => setEditingProject({...editingProject, budget: Number(e.target.value) || null})} className="w-full p-2 border rounded" />
                         ...
                         <input type="number" placeholder="Estimated Hours" value={editingProject.estimated_hours ?? ''} onChange={e => { const val = parseInt(e.target.value); setEditingProject({...editingProject, estimated_hours: isNaN(val) ? null : val }); }} className="w-full p-2 border rounded" />
