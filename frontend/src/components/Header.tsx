                    ...
                    {currentUser && (
                        <div className="flex items-center space-x-2">
                             <div className="flex items-center bg-blue-50 px-3 py-1.5 rounded-full">
                                ...
                                <span className="hidden sm:inline-block ml-2 bg-blue-200 text-blue-800 text-xs px-2 py-0.5 rounded-full capitalize">{currentUser.role}</span>
                            </div>
                            <button onClick={logout} className="p-2 rounded-full text-gray-600 hover:bg-red-100 hover:text-red-600 transition-colors" title="Odhlásiť">
